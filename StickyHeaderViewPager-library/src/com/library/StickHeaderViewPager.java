 ...
 */
public class StickHeaderViewPager extends StickHeaderLayout implements ScrollHolder,
	...
	public StickHeaderViewPager(Context context, AttributeSet attrs) {
		...
		// add stickheader
		mStickheader = new LinearLayout(mContext);
	...
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
		...
		if (positionOffsetPixels > 0) {
			...
			fragmentContent.adjustScroll((int) (mStickheader.getHeight() + mStickheader.getTranslationY()),
					mStickheader.getHeight());
		}
	}
	...
	public void onPageSelected(int position) {
		...
		currentHolder.adjustScroll((int) (mStickheader.getHeight() + mStickheader.getTranslationY()),
				mStickheader.getHeight());
	}
