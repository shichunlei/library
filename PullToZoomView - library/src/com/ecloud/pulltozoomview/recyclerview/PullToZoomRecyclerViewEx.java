 ...
 */
public class PullToZoomRecyclerViewEx extends PullToZoomBase<RecyclerView> implements
	...
	private void removeHeaderView() {
		if (mHeaderContainer != null) {
			if (mRootView != null && mRootView.getAdapter() != null) {
				...
				RecyclerViewHeaderAdapter<RecyclerView.ViewHolder> mAdapter = (RecyclerViewHeaderAdapter<RecyclerView.ViewHolder>) mRootView
						.getAdapter();
		...
		if (mHeaderContainer != null) {
			...
			if (mRootView != null && mRootView.getAdapter() != null) {
				...
				if (mAdapter != null) {
					...
					RecyclerViewHeaderAdapter.ExtraItem mExtraItem = new RecyclerViewHeaderAdapter.ExtraItem(
							RecyclerViewHeaderAdapter.INT_TYPE_HEADER, new RecyclerView.ViewHolder(
									mHeaderContainer) {
								@Override
	...
	private boolean isFirstItemVisible() {
		if (mRootView != null) {
			...
			if (null == adapter || adapter.getItemCount() == 0) {
				 ...
				 * internally use a HeaderView which messes the positions up.
				 * For now we'll just add one to account for it and rely on the
	...
	public void handleStyledAttributes(TypedArray a) {
		...
		if (mAdapter != null) {
			RecyclerViewHeaderAdapter.ExtraItem mExtraItem = new RecyclerViewHeaderAdapter.ExtraItem(
					RecyclerViewHeaderAdapter.INT_TYPE_HEADER, new RecyclerView.ViewHolder(mHeaderContainer) {
						@Override
						public String toString() {
							return super.toString();
						}
			...
			if (mZoomView != null) {
				...
				if ((!mIsFinished) && (mScale > 1.0D)) {
					...
					f2 = mScale - (mScale - 1.0F)
							* PullToZoomRecyclerViewEx.sInterpolator.getInterpolation(f1);
