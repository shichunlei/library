...
public class ECPullToZoomScrollViewToolbarEx extends PullToZoomBase<ScrollView> {
			...
			if (mZoomView != null) {
				...
				if ((!mIsFinished) && (mScale > 1.0D)) {
					...
					f2 = mScale - (mScale - 1.0F)
							* ECPullToZoomScrollViewToolbarEx.sInterpolator.getInterpolation(f1);
	 ...
	 */
	@SuppressWarnings("deprecation")
	public void setToolbarInitBackgroundResource(int resid) {
	 ...
	 */
	@SuppressWarnings("deprecation")
	public void setToolbarChangeBackgroundResource(int resid) {
