...
import com.aspsine.swipetoloadlayout.view.widget.RingProgressDrawable;
...
public class GoogleRefreshHeaderView extends FrameLayout implements SwipeTrigger, SwipeRefreshTrigger {
	...
	public GoogleRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		ringProgressDrawable.setColors(res.getColor(R.color.google_blue), res.getColor(R.color.google_red),
				res.getColor(R.color.google_yellow), res.getColor(R.color.google_green));
		mTriggerOffset = context.getResources()
				.getDimensionPixelOffset(R.dimen.refresh_trigger_offset_google);
	}
