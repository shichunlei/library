...
import com.aspsine.swipetoloadlayout.view.widget.GoogleCircleProgressView;

/**
 * Created by aspsine on 16/1/27.
 */
public class GoogleCircleHookLoadMoreFooterView extends FrameLayout implements SwipeTrigger,
	...
	public GoogleCircleHookLoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mTriggerOffset = context.getResources().getDimensionPixelOffset(
				R.dimen.load_more_footer_height_google);
