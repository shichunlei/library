...
public abstract class LineScatterCandleRadarRenderer extends DataRenderer {
	...
	/**
	 * path that is used for drawing highlight-lines (drawLines(...) cannot be
	 * used because of dashes)
	 */
	private Path mHighlightLinePath = new Path();

	public LineScatterCandleRadarRenderer(ChartAnimator animator,
