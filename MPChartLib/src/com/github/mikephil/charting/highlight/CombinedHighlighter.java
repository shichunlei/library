 ...
 */
public class CombinedHighlighter extends
		ChartHighlighter<BarLineScatterCandleBubbleDataProvider> {
	...
	/**
	 * Returns a list of SelectionDetail object corresponding to the given
	 * xIndex.
	 *
	 * @param xIndex
	 * @return
